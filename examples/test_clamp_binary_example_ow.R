...
# using clamp_binary with Overlap Weighting (OW) adjustment.
...
# Compute overlap weights (OW)
W <- ifelse(X == 1, 1 - PS, PS)
...
cat(sprintf("  clamp_binary (WITH OW): %d/%d true variables detected\n",
