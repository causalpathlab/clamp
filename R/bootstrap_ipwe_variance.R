#' @title Bootstrap the variance of inverse-probability weighting estimator
#' @description This function estimates the variance of each regression coefficient,
#' i.e., the average treatment effect (ATE) of each treatment (variable), by
...
#' @keywords internal
bootstrap_ipwe_variance <- function(X, y, W, nboots = 100, seed = NULL) {
